 ...
 */
export function createTranslator(config?: { url?: string; apiKey?: string }): TranslateFn {
    ...
    return async function translateText(text: string, fromLang: string, toLang: string): Promise<string> {
