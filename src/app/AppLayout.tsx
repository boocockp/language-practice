            ...
            <header className="border-b border-slate-200 pt-safe">
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                        <DropdownMenu open={navMenuOpen} onOpenChange={(open) => setNavMenuOpen(open)}>
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenu.Content>
                                {LANGUAGES.map(({ code, name }) => (
                                    <DropdownMenu.Item key={code} onClick={() => setLanguage(code)} className="min-h-7">
                                        {name}
                                    </DropdownMenu.Item>
                                ))}
                            </DropdownMenu.Content>
                                    ...
                                    <Popover>
                                        ...
                                        <Popover.Content side="bottom" align="end">
                                            <div className="flex flex-col gap-3 p-2">
                                                <p className="text-sm text-slate-600" id="account-description">
