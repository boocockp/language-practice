...
import { renderAppLayout, renderAppLayoutWithAuth, screen, STORAGE_KEY } from "../test-utils";
...
describe("AppLayout", () => {
    ...
    describe("login and logout", () => {
        ...
        describe("User icon popover content", () => {
            ...
            it("shows Signed in and Log out when user has neither email nor name", async () => {
