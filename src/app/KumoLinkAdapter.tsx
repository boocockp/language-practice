...
type KumoLinkProps = Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, "href"> & { to?: string };
 ...
 */
export const KumoRouterLink = forwardRef<HTMLAnchorElement, KumoLinkProps>(function KumoRouterLink(
    { to, ...rest },
    ref,
) {
