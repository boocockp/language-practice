...
import { renderAppLayoutWithAuth, screen, STORAGE_KEY } from "../test-utils";
...
describe("Login", () => {
    ...
    describe("Sign-up flow", () => {
        it("shows sign-up step when Sign up instead is clicked", async () => {
            ...
            await user.click(screen.getByRole("button", { name: "Log in" }));
            await user.click(await screen.findByRole("button", { name: "Sign up instead" }));

            expect(screen.getByRole("heading", { name: "Sign up" })).toBeInTheDocument();
            expect(screen.getByText("Create an account with your email and password.")).toBeInTheDocument();
