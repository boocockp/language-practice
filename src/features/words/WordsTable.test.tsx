...
describe("WordsTable", () => {
    ...
    it("renders column headers Text, Meaning, Tags", () => {
        customRender(<WordsTable words={[]} selectedWordId={null} onRowClick={() => {}} />);
    ...
    it("renders each word with correct text, meaning, and tags in cells", () => {
        ...
        customRender(<WordsTable words={words} selectedWordId={null} onRowClick={() => {}} />);
    ...
    it("calls onRowClick with word _id when a row is clicked", async () => {
        ...
        customRender(<WordsTable words={words} selectedWordId={null} onRowClick={onRowClick} />);
        const rows = screen.getAllByRole("row").slice(1);
    ...
    it("applies selected row styling when selectedWordId matches", () => {
        ...
        customRender(<WordsTable words={words} selectedWordId={"w2" as Id<"words">} onRowClick={() => {}} />);
        const rows = screen.getAllByRole("row").slice(1);
