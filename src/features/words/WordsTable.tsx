...
function formatWordWithType(word: { text: string; type: WordType }): ReactNode {
    return (
        <>
            <span>
                {word.text}
...
export function WordsTable({ words, selectedWordId, onRowClick }: WordsTableProps) {
    function handleKeyDown(e: React.KeyboardEvent, wordId: Id<"words">) {
