...
export function QuestionTypesTable({ questionTypes, selectedQuestionTypeId, onRowClick }: QuestionTypesTableProps) {
    function handleKeyDown(e: React.KeyboardEvent, questionTypeId: Id<"questionTypes">) {
                    ...
                    {questionTypes.map((qt) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Table.Cell>
                                    <span className="block min-w-0 truncate" title={qt.questionTemplate}>
                                        {qt.questionTemplate || "—"}
                                    </span>
                                </Table.Cell>
                            </Table.Row>
